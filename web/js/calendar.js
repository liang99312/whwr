...
function addCalendar(){
	...
	$("#calendarLayer").append("<iframe id='calendarIframe' name='calendarIframe' src='/whwr/calendar/calendar.html' scrolling=no frameborder=0 width=100% height=100%></iframe>");
}
